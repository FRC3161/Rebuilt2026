...
// params.uncompensated_yaw_angle_deg = turret_angle_deg +
// turret_error.getDegrees();
// params.effective_yaw_angle_deg = params.uncompensated_yaw_angle_deg;
// Translation2d velocity_translational = new Translation2d(robotVelocity.dx,
// robotVelocity.dy);
// // Rotate by robot-to-goal rotation; x = radial component (positive towards
// // goal), y = tangential component (positive means turret needs negative
// lead).
// velocity_translational =
// velocity_translational.rotateBy(aimingParams.getRobotToGoalRotation().unaryMinus());
...
// double shot_speed = params.uncompensated_range_m / shotTime -
// radial_component;
// if (shot_speed < 0.0)
// shot_speed = 0.0;
// double turret_adjustment =
// Units.radiansToDegrees(Math.atan2(-tangential_component, shot_speed));
// params.effective_yaw_angle_deg += turret_adjustment;
// params.effective_range_m = shotTime
// * Math.sqrt(tangential_component * tangential_component + shot_speed *
// shot_speed);
...
// + Units.radiansToDegrees(tangential_component /
// params.uncompensated_range_m));
